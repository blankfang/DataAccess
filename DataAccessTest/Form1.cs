...
namespace DataAccessTest
{
    public partial class Form1 : Form
    {
        ...
        {
            DbOpearte Opearte = new DbOpearte("Oracle");
            Opearte.RecordUpdate(true);
        }

        private void GetTbByProcedure_Click(object sender, EventArgs e)
        {
            DbOpearte Opearte = new DbOpearte("Oracle");
            Opearte.GetTbByProcedure();
        }
